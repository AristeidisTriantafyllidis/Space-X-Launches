...
export default function DetailPage(props) {
  ...
  return (
    <div className="detailPage">
      <button
        aria-label="Gets you back to main  page"
      ...
      <p>
        Links aricle{" "}
        <a target=".blank" href={props.data?.links?.article}>
          {props.data?.links?.article}
        </a>{" "}
      </p>
      <p>
        Webcast:{" "}
        <a target=".blank" href={props.data?.links?.webcast}>
          {props.data?.links?.webcast}
        </a>
      </p>
      <p>
        wikipedia
        <a target=".blank" href={props.data?.links?.wikipedia}>
          {props.data?.links?.wikipedia}
        </a>
      </p>
    </div>
  );
